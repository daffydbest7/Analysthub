...
const FormNeco = () => {
 ...
 const handleSchoolCodeChange = (event) => {
  ...
  const handleSubmit = (event) => {
    ...
    fetch('https://script.google.com/macros/s/AKfycbz3_c6MKbOTH_lC56qgMLbOuCMv5sUtSALxYhcini9qhLXpICm62H9-opm_Ztm-OrnA/exec', {
      method: 'POST',
      body: formData,
      mode: 'no-cors'
    })
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="md:pb-20 bg-gradient-to-tl from-mainColor to-slate-600 shadow-md rounded px-8 md:px-20 pt-6 pb-8 mb-4">
     ...
     <div className="w-2/3 md:w-2/6 px-3 mb-6 md:mb-0 justify-center">
          ...
          <span className='text-slate-200'>BY/PUBL/NECO/ </span>
